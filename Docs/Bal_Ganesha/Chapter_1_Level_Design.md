...
|---|---|---|---|---|
| 01 `LVL_C01_001` | Ganesha spots the first modak jar hanging above the courtyard. Break its support. | **Erase** the single vertical rope. Success drops and safely breaks the jar, revealing modaks. | Palace exterior; Ganesha lower-left, hanging jar upper-right, clean finger lane around rope; background pots are subdued decoration. | Crawl/look; rope threads dissolve; jar falls and opens; gold crumbs, clay knock, happy chime. |
| 02 `LVL_C01_002` | A large serving jar is beyond a messy floor obstruction. Clear Ganesha's route. | **Erase** the butter spill and scattered blocking clay pieces. Success lets Ganesha reach the jar. | Palace exterior floor; Ganesha left, large jar right, broad spill/shard band between them. No basket pile. | Crawl through cleared route, reach jar; soft wipe dust and reward sting. |
| 03 `LVL_C01_003` | A closed wall cupboard hides the missing treats. Open its view. | **Erase** the single cupboard door. Success reveals exactly three bowls of modaks. | Indoor storeroom; one wall cupboard center-right, large floor jar and column as noninteractive context. | Curious look; door wipes away; warm shelf glow and three reward sparkles; wood-rub SFX. |
| 04 `LVL_C01_004` | A wooden balance holds two unequal covered loads. Remove the small weight. | **Erase** the smaller left weight. Success rotates the beam toward the large reward jar. | Central fulcrum and beam; small target left, large covered load right; rotation space remains clear. | Think; weight dissolves, beam tips, reward jar appears; wood creak and ceramic chime. |
| 05 `LVL_C01_005` | Three covered pots form a triangle. Find the pot hiding modaks. | **Erase** the lower-center cover. Success reveals the filled jar; the two upper covers remain. | Covered pots at upper-left, upper-right and lower-center with generous separation; subtle fair-play clue at the correct cover. | Inspect; lower cloth dissolves, modak sparkle, celebration pose; fabric rub and sparkle arpeggio. |
