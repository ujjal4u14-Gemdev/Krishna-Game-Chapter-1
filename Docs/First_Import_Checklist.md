...
3. Run `Tools > Bal Ganesha Game > Setup Project`.
...
9. Run `Tools > Bal Ganesha Game > Validate Project`.
10. Enter Play Mode, verify success and failure/reset, then test a portrait Android build.

## Immediate playable test

Run `Tools > Bal Ganesha Game > Create Playable Greybox Demo`. The tool generates and opens a dependency-free scene with all three Chapter 1 puzzle families. Press Play and follow the instructions at the top of the Game view.
